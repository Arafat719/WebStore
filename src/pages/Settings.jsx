    ...
    <div className="wmx-panel">
      <div className="wmx-card">
        ...
        <div className="wmx-avatar-upload">
          <div className="wmx-avatar-circle">A</div>
        ...
        <div className="wmx-form-row">
          <div className="wmx-form-group">
            <label className="wmx-label">First Name</label>
            <input className="wmx-input" type="text" defaultValue="Arafat" />
          </div>
          <div className="wmx-form-group">
            <label className="wmx-label">Last Name</label>
            <input className="wmx-input" type="text" defaultValue="Khan" />
          </div>
        </div>
        ...
        <div className="wmx-form-group">
          ...
          <input className="wmx-input" type="text" defaultValue="@arafat" />
          <span className="wmx-hint">webmarketx.com/u/arafat</span>
        </div>

        <div className="wmx-form-group">
          <label className="wmx-label">Bio</label>
          <textarea
            className="wmx-textarea"
            defaultValue="Digital product creator & UI designer. Building tools that matter."
          />
        </div>

        <div className="wmx-form-group">
          <label className="wmx-label">Website / Portfolio URL</label>
          <input className="wmx-input" type="url" placeholder="https://yoursite.com" />
        </div>

        <button className="wmx-btn-save">Save Profile</button>
      </div>
    </div>
  );
}
    ...
    <div className="wmx-panel">
      ...
      <div className="wmx-card">
        ...
        <div className="wmx-form-group">
          ...
          <input className="wmx-input" type="email" defaultValue="arafatkhan0186@gmail.com" />
        </div>
        <div className="wmx-form-group">
          <label className="wmx-label">New Email</label>
          <input className="wmx-input" type="email" placeholder="new@email.com" />
        </div>
        <button className="wmx-btn-save">Update Email</button>
      </div>
      ...
      <div className="wmx-card">
        ...
        <div className="wmx-form-group">
          ...
          <div className="wmx-input-wrap">
            <input className="wmx-input" type={vis.cur ? 'text' : 'password'} placeholder="••••••••" value={currentPassword} onChange={e => setCurrentPassword(e.target.value)} />
        ...
        <div className="wmx-form-row">
          <div className="wmx-form-group">
            ...
            <div className="wmx-input-wrap">
              <input className="wmx-input" type={vis.nxt ? 'text' : 'password'} placeholder="••••••••" value={newPassword} onChange={e => setNewPassword(e.target.value)} />
          ...
          <div className="wmx-form-group">
            ...
            <div className="wmx-input-wrap">
              <input className="wmx-input" type={vis.cfm ? 'text' : 'password'} placeholder="••••••••" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} />
        ...
        {passwordMsg.text && (
          <p style={{ fontSize: "0.82rem", marginBottom: "0.5rem", color: passwordMsg.type === "error" ? "#ff6b6b" : "#34d399" }}>
            {passwordMsg.text}
          </p>
        )}
      ...
      <div className="wmx-danger-card">
        ...
        <button className="wmx-btn-danger">Delete My Account</button>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="wmx-panel">
      <div className="wmx-card">
        ...
        <button className="wmx-btn-save">Save Preferences</button>
      </div>
    </div>
  );
}
    ...
    <div className="wmx-panel">
      <div className="wmx-card">
        ...
        <div className="wmx-form-group">
          ...
          <input className="wmx-input" type="text" defaultValue="ArafatDesigns" />
        ...
        <div className="wmx-form-group">
          ...
          <input
            className="wmx-input"
            type="text"
            defaultValue="Premium digital assets for modern creators"
        ...
        <div className="wmx-form-group">
          ...
          <div className="wmx-radio-group">
            <label className="wmx-radio-opt">
              <input type="radio" name="payout" defaultChecked /> Bank Transfer
            </label>
            <label className="wmx-radio-opt">
              <input type="radio" name="payout" /> PayPal
            </label>
            <label className="wmx-radio-opt">
              <input type="radio" name="payout" /> Wise
            </label>
          </div>
        </div>
        ...
        <div className="wmx-toggle-row" style={{ borderBottom: 'none' }}>
          ...
          <label className="wmx-switch">
            <input type="checkbox" checked={listingPublic} onChange={() => setListingPublic(v => !v)} />
            <span className="wmx-switch-track" />
          </label>
        </div>

        <button className="wmx-btn-save">Save Seller Settings</button>
      </div>
    </div>
  );
}
    ...
    <div className="wmx-panel">
      <div className="wmx-card">
        ...
        <div className="wmx-form-group">
          ...
          <span className="wmx-hint" style={{ marginBottom: '0.7rem', display: 'block' }}>
            Light theme is a placeholder — full support coming soon.
          </span>
          <div className="wmx-theme-row">
            <button
              className={`wmx-theme-opt ${theme === 'dark' ? 'wmx-selected' : ''}`}
              onClick={() => setTheme('dark')}
            >
              <div className="wmx-theme-preview wmx-dark" />
              <p className="wmx-theme-label">Dark</p>
            </button>
            <button
              className={`wmx-theme-opt ${theme === 'light' ? 'wmx-selected' : ''}`}
              onClick={() => setTheme('light')}
            >
              <div className="wmx-theme-preview wmx-light" />
              <p className="wmx-theme-label">Light</p>
            </button>
          </div>
        </div>
